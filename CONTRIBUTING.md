...
Please read these guidelines before contributing to meziantou/Meziantou.DotNet.CodingStandard:
...
If you have questions about how to use meziantou/Meziantou.DotNet.CodingStandard, please open a GitHub issue.
...
- Check that new and updated code follows meziantou/Meziantou.DotNet.CodingStandard's existing code formatting and naming standard
- Run meziantou/Meziantou.DotNet.CodingStandard's unit tests to ensure no existing functionality has been affected
...
By contributing your code to meziantou/Meziantou.DotNet.CodingStandard you grant Gérald Barré a non-exclusive, irrevocable, worldwide,
